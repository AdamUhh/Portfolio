  ...
  return (
    <section className="titlebar-height flex items-center justify-center border-b-2 border-b-black bg-titlebar p-2 pl-3 text-md">
      ...
      <div className="ml-auto flex flex-1 items-center">
        <button
          className="ml-auto flex h-[14px] w-[14px] cursor-pointer items-center justify-center rounded-full bg-[#ff5f57] hover:brightness-90"
          type="button"
          onClick={closeTab}
        >
        ...
        ></button>
        <button
          className="ml-2 h-[14px] w-[14px] cursor-pointer rounded-full bg-[#28c840] hover:brightness-90"
          type="button"
          onClick={handle.active ? handle.exit : handle.enter}
        ></button>
      </div>
