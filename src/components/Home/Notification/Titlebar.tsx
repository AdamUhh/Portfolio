...
export default function NotificationTitlebar({
  ...
  return (
    <div className="draggable-handle flex h-10 w-full cursor-grab items-center justify-between rounded-tl-2xl rounded-tr-2xl bg-gradient-to-r from-[#87a7ec] to-[#a6d0f0] px-4 py-2 border-b border-b-black/40">
