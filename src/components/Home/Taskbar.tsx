...
const Taskbar = () => (
  <footer className="taskbar-bg absolute bottom-0 left-0 grid h-12 w-screen grid-cols-3">
    <div />
    ...
    <ul className="ml-auto grid h-full grid-cols-[1fr_1fr_1fr_1fr_100px]">
      ...
      <DesktopItem path={mdiVolumeHigh} size={0.8} title="Time">
        <Time isHome />
      </DesktopItem>
    </ul>
  </footer>
